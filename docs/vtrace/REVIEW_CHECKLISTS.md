...
| Product / Infrastructure Review | Product behavior remains distinct from VTRACE machinery; the 100-line tripwire and reuse/two-adopter paths are explicit. | yes | pass | `docs/framework/product-first-infrastructure-budget.md`. |
