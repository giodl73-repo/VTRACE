...
| S1 Specification Baseline | pass | pass | DCRs through DCR-013 are current and implemented. |
| S2 Design Baseline | pass | pass | Profiles, evidence, gates, and source controls are baselined. |
| S3 Implementation Planning | pass | pass | Work packages WP-001..WP-013 are closed. |
| S4 Work Package Execution | pass | pass | WP-001..WP-013 complete. |
...
| S1 | `REQUIREMENTS.md`, `SPECIFICATION_BASELINE.md`, `SPEC_MODEL.md` | L0 | systems engineering / traceability | `docs/vtrace/TRACE.md` |
| S2 | `ARCHITECTURE.md`, `INTERFACES.md`, `DESIGN.md`, `CODE_RIGOR.md`, `PACKAGE_BOUNDARIES.md`, `CONTRACT_BOUNDARIES.md`, `SCENARIO_MODEL.md` | L0 / L1 | V&V / assurance | `docs/vtrace/REVIEW.md` |
