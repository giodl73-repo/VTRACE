...
|---|---|---|---|---|---|---|---|
| WP-001 | Add lightweight validators. | DCR-001 / REQ-VAL-001 / CR-001..CR-003 | `tools/` or scripts, docs, templates | Artifact contracts stable. | Validator catches missing files, ID coverage gaps, and incomplete WP/review lanes. | L0: docs/check tests / L1: full validator run / L2: run on example repos | proposed |
