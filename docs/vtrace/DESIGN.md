...
| DES-007 | User-facing documentation is derived from, but separate from, controlled specs. | Specs control engineering intent; concepts, how-to guides, tutorials, examples, traces, decks, and corpus governance explain accepted behavior to users and stakeholders. | REQ-COMMS-001, SPEC-018, DCR-011 | accepted |
