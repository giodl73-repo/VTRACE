...
| REQ-COMMS-001 | NEED-001 / NEED-003 / CON-004 | Define source-to-user-docs communications strategy. | SPEC-018 | ARCH-010 / DES-007 / IF-009 | WP-011 / WP-012 | `docs/framework/communications-strategy.md`, `templates/adoption/COMMUNICATIONS_STRATEGY.md`, `docs/vtrace/COMMUNICATIONS_STRATEGY.md`, `docs/README.md`, `docs/CORPUS.md`, `docs/concepts/`, `docs/how-to/`, `docs/tutorials/`, `docs/examples/`, `docs/traces/`, `docs/decks/`, `src/`, `tests/cli.rs` | validator, CLI integration tests, and inspection | VAL-011 | EVID-051 / EVID-052 / EVID-053 | verified |
