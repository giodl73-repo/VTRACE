...
| `vtrace work close WP-###` | Report closure readiness across exit criteria, affected surfaces, evidence expectations, validation status, review lane counts/names, work-package status, and git scope; block incomplete closure. | `WORK_PACKAGES.md`, `VERIFICATION.md`, `VALIDATION.md`, `EVIDENCE.md`, `REVIEW.md`. |
