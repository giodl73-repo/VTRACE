...
| `vtrace work close WP-###` | Report closure readiness across exit criteria, affected surfaces, evidence expectations, validation status, review lane counts/names, work-package status, git scope, and changed paths; block incomplete closure. | `WORK_PACKAGES.md`, `VERIFICATION.md`, `VALIDATION.md`, `EVIDENCE.md`, `REVIEW.md`. |
