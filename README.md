...
review`, `agent brief`, and `worktree plan` help maintainers run the process
procedurally. LLM provider integrations remain future optional helpers; they
may draft or review, but they do not replace canonical VTRACE artifacts or
objective evidence.
