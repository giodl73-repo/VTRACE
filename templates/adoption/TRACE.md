...
- `Requirement ID`: stable repo-local identifier.
...
- `Evidence Pointer`: command output, CI run, report, review finding, receipt, or artifact path.
- `Status`: proposed, accepted, implemented, verified, validated, waived, or retired.
